...
for t in range(7):
    ...
    dic = {}
    pagelen = requests.get(('https://bankpoultry.com/modules.php?name=Bank&t={}').format(t+1))
    pagelen = html.fromstring(pagelen.content)
    pglen = len(pagelen.xpath('//body/table/tr[6]/td[2]/table[2]/tr/td[2]/table[3]/tr/td/table/tr/td/table/tr/td/table/tr/td/table[2]/tr/td'))

    for counter in range(pglen):
        # Request the page
        url = 'https://bankpoultry.com/modules.php?name=Bank&t={}&page={}'
        page = requests.get(url.format(t+1 , counter))
        # Parsing the page
